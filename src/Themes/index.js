 export const themes = {
    light: {
        ...
        containerBgGradientColor: 'radial-gradient(80rem at 22% -60%, #eaeae0 97%, #d6d6d4 97%, #eaeae0 100%)',
        mainBorderColor: '#fff',
    ...
    dark: {
        containerBgColor: '#323133',
        containerBgGradientColor: 'radial-gradient(80rem at 22% -60%, #484848 97%, #3c3c3c 97%, #52524e 100%)',
        mainBorderColor: '#eee',
